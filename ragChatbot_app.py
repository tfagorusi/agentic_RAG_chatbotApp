...
__import__('pysqlite3') # comment this line out when running on your local machine
import sys  # comment this line out when running on your local machine
sys.modules['sqlite3'] = sys.modules.pop('pysqlite3')# comment this line out when running on your local machine
